...
document.getElementById("id_proyecto").addEventListener("input", function () {
...
function guardarReserva() {
  ...
  const id_proyecto = document.getElementById("id_proyecto").value.trim();
  ...
  if (!id_proyecto || !nombreProyecto || !fecha || !horaInicio || !horaFin) {
